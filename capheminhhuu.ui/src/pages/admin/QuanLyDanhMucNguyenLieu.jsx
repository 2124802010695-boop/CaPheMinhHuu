...
import ModalAddIngredientCategory from '../../components/admin/ModalAddIngredientCategory';
...
const QuanLyDanhMucNguyenLieu = () => {
    ...
    const fetchCategories = async () => {
        try {
            ...
            console.error("Lỗi lấy danh mục nguyên liệu:", error);
        }
    };
    ...
    const handleDelete = async (id) => {
        if (window.confirm("Bạn có chắc chắn muốn xóa danh mục nguyên liệu này?")) {
            try {
                await deleteIngredientCategoryAPI(id);
                alert("Xóa thành công!");
                fetchCategories();
            } catch (error) {
                alert("Lỗi xóa danh mục nguyên liệu!");
            }
        }
    };
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                        <Avatar sx={{
                            ...
                            <InventoryIcon sx={{ color: '#10b981', fontSize: 28 }} />
                        </Avatar>
                        <Box>
                            ...
                            <Typography variant="body2" sx={{ color: '#6b7280' }}>
                                Quản lý danh mục nguyên liệu trong kho
                            </Typography>
                        </Box>
                    </Box>
                    <Button
                                ...
                                <TableRow>
                                    <TableCell colSpan={4} align="center" sx={{ py: 8 }}>
                                        <Box sx={{
                                            ...
                                            <InventoryIcon sx={{ fontSize: 48, color: '#d1d5db' }} />
                                            <Typography sx={{ color: '#9ca3af', fontWeight: 500 }}>
                                                Chưa có danh mục nguyên liệu nào
                                            </Typography>
...
export default QuanLyDanhMucNguyenLieu;
